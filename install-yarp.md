...
1. Not recommended yet (e.g. see https://github.com/robotology-playground/yarp-matlab-bindings/issues/22): New repo directly against MATLAB. Note that it links against MATLAB libs, so you must match compiler in addition to bits (Windows MATLAB 2017b only provides 64-bit mingw version). Ref: https://github.com/robotology-playground/yarp-matlab-bindings
